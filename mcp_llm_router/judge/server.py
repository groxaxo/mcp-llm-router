...
from mcp_llm_router.judge.db.conversation_history_service import (
...
from mcp_llm_router.judge.tool_description.factory import (
...
setup_logging("INFO")
# The unified router registers judge tools into its FastMCP instance.
# Keep a reference here for compatibility with legacy imports.
...
def register_judge_tools(mcp_server: FastMCP) -> None:
    ...
    mcp_server.add_tool(
        raise_obstacle,
        description=tool_description_provider.get_description("raise_obstacle"),
    )
    mcp_server.add_tool(
    ...
    mcp_server.add_tool(
        judge_coding_plan,
        description=tool_description_provider.get_description("judge_coding_plan"),
    )
    mcp_server.add_tool(
        judge_code_change,
        description=tool_description_provider.get_description("judge_code_change"),
    )
    mcp_server.add_tool(
